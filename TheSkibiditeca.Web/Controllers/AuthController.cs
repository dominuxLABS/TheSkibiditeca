...
public class AuthController(LibraryDbContext context, UserManager<User> userM, SignInManager<User> singIn) : Controller
{
    private readonly LibraryDbContext db = context;
    private readonly UserManager<User> userM = userM;
    private readonly SignInManager<User> singIn = singIn;
